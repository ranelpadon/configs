...
#c.InteractiveShell.banner1 = 'Python 2.7.17 (default, Jul 18 2020, 10:15:21) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.8.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
from IPython.terminal.prompts import (
    Prompts,
    Token,
)
...
PROMPT_IN = 'λ  ' if PY3 else 'λ  '.decode('utf-8')
PROMPT_OUT = 'Φ  ' if PY3 else 'Φ  '.decode('utf-8')

class MyPrompt(Prompts):

    def in_prompt_tokens(self, cli=None):
        tokens = [
            (Token.Prompt, PROMPT_IN)
        ]
        return tokens

    def out_prompt_tokens(self):
        tokens = [
            (Token.OutPrompt, PROMPT_OUT)
        ]
        return tokens
