# Generated by Powerlevel10k configuration wizard on 2020-08-09 at 02:59 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=white
  # Ranel
  # typeset -g POWERLEVEL9K_PYENV_BACKGROUND=216
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=red
